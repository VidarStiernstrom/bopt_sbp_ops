function [H, HI, D1, D2, DI] = bopt_ops_6(N, h, options)
    ...
    min_inds = implementations.d2_sparsity_pattern_inds(m, order, BP, 0, 3);
    nonmin_inds = implementations.d2_sparsity_pattern_inds(m, order, BP, 1, 3);

    % narrow 7 point stencil width
    ...
    %  Non-narrow 9 point stencil width
